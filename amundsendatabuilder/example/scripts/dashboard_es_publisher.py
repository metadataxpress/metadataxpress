...
from amundsendatabuilder.databuilder.extractor.neo4j_dashboard_search_data_extractor import Neo4jDashboardSearchDataExtractor
from amundsendatabuilder.databuilder.job.job import DefaultJob
from amundsendatabuilder.databuilder.loader.file_system_elasticsearch_json_loader import FSElasticsearchJSONLoader
from amundsendatabuilder.databuilder.extractor.neo4j_extractor import Neo4jExtractor
from amundsendatabuilder.databuilder.publisher.elasticsearch_publisher1 import ElasticsearchPublisher
...
def create_neo4j_es_job():
    ...
    job_config = ConfigFactory.from_dict({
        ...
        'extractor.dashboard_search_data.extractor.neo4j.{}'.format(Neo4jExtractor.MODEL_CLASS_CONFIG_KEY):
            'amundsendatabuilder.databuilder.models.dashboard_elasticsearch_document.DashboardESDocument',
